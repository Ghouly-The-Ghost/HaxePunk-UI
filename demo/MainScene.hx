...
class MainScene extends Scene
{
	public function new()
	{
		...
		parentLayout.layoutData.offsetX = 250;

		var layout = new LayoutGroup(0.25, LayoutType.Vertical);
		layout.spacing = 32;
		...
		btn.inputEabled = false;
		layout.add(btn);
		var grp = new RadioButtonGroup(function() trace("CHANGED"));
		var btn = new RadioButton(grp, "id1", 0, 0, 54, 24, "Option 1", mouseManager);
		layout.add(btn);
